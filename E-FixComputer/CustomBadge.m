...
- (void) autoBadgeSizeWithString:(NSString *)badgeString
{
    ...
    CGSize stringSize = [badgeString sizeWithAttributes:[NSDictionary dictionary]];
//	CGSize stringSize = [badgeString sizeWithFont:[UIFont boldSystemFontOfSize:11]];
	CGFloat flexSpace;
...
-(void) drawRoundedRectWithContext:(CGContextRef)context withRect:(CGRect)rect
{
    ...
    CGContextSetShadowWithColor(context, CGSizeMake(1.0,1.0), 3, [[UIColor clearColor] CGColor]);
...
- (void)drawRect:(CGRect)rect {
	...
	if ([self.badgeText length]>0) {
        ...
        NSDictionary *attributes = [NSDictionary dictionaryWithObjectsAndKeys:textFont, NSFontAttributeName, [UIColor whiteColor], NSForegroundColorAttributeName, nil];
